...
{
    public static void MakeReservationEmployee()
    {
        var foodMenu = new FoodMenu();
    ...
    public static void CancelReservationEmployee()
    {
        AccountsLogic accountsLogic = new AccountsLogic();

        ViewReservationEmployee();
    ...
    public static void ViewReservationEmployee()
    {
        AccountsLogic accountsLogic = new AccountsLogic();
        var allUsers = accountsLogic.LoadAllUsers();
    ...
    public static void ChangeReservationEmployee()
    {
        AccountsLogic accountsLogic = new AccountsLogic();
